...
import ro.fasttrackit.curs4.curs4.homework.Person;
import ro.fasttrackit.curs4.curs4.homework.PersonService;
...
class PersonServiceTest {
  ...
  void testList(){
    ...
    Assertions.assertThat (service.groupByRangeAge (5, 15, 25)).containsExactlyInAnyOrderEntriesOf (Map.of (
